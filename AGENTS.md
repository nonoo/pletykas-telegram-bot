...
- `<SCHEDULE:oneshot>`:
  ```text
  <SCHEDULE:oneshot>
  Time: <ISO datetime, HH:MM, or relative offset '+2h', 'in 30m', 'in 3 days', 'in 2 months', 'in 1 year'>
...
- `<SCHEDULE:periodic>`:
  ```text
  <SCHEDULE:periodic>
  Interval: <recurrence interval '30m', '12h', '1d', '3 days', '2 weeks', '1 month', '3 months', '1 year'>
  Start: <optional first execution time or relative offset>
